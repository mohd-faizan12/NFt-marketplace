      ...
      //  axios(result)
        if (result && result.data && result.data.url) {
          let data1 = `https://${result.data.url}/fileupload`;          
            ...
            formData.append('files', Credential.video.buffer, Credential.video.originalname)     
            ...
            // });          
          return response.Success("final",{...result1.data.responseArray[0],"sessionKey":result.data.sessionKey});
